...
__all__ = ('SqueezePluginRenderer', 'Regions', 'default_context', 'renderer')

"""
Squeezemail note: This is taken from feincms3 nearly line for line because content_editor's renderer is a bit bare bones
Thanks to matthiask
"""
...
class SqueezePluginRenderer(object):
    """
...
renderer = SqueezePluginRenderer()


try:
    from squeezemail_extensions.renderer import *
except ImportError as error:
    logger.error("You need to create a squeezemail_extensions app with renderer.py inside.")
...
# renderer.register_template_renderer(
#     Recipe,
#     'squeezemail/plugins/recipe.html',
# )
